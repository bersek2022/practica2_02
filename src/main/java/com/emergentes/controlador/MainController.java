...
public class MainController extends HttpServlet {
 ...
 obj1.setPrioridad(request.getParameter("pioridad"));
 obj1.setCompletado(request.getParameter("completodo"));
 ...
 HttpSession ses = request.getSession();
 ArrayList<Tareas> lista= (ArrayList<Tareas>) ses.getAttribute("listtar"); //To change body 
